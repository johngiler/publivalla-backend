...
from apps.workspaces.utils.smtp_test import run_transactional_smtp_connection_test
from apps.workspaces.utils.mailgun_test import run_transactional_mailgun_auth_test
...
class MyWorkspaceView(APIView):
    ...
    def patch(self, request):
        ...
        if "logo_png_artifacts" in request.FILES:
            ws.logo_png_artifacts = request.FILES["logo_png_artifacts"]
        if _truthy_form_value(request.data.get("remove_logo_png_artifacts")):
